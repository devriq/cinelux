...
export default function MovieShow(props: {movie: Movie; status:any[]}): JSX.Element {
  ...
  return (
    <div className={`${movieState} movieShow w-[230px] h-[330px] border-2 border-green-300 flex flex-col items-center rounded-xl overflow-hidden hover:grayscale-0`}>

    <div className={`moviePoster w-[230px] h-[330px] flex flex-col items-center rounded-xl overflow-hidden`}>
      <img className={`w-[230px] transition-colors`} src={moviePoster} alt="poster"/>
    </div>
